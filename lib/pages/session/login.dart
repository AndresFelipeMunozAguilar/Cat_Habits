...
class Login extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Container(
        color: const Color(0xFFFFEA91), // Color de fondo para toda la pantalla
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          decoration: const BoxDecoration(
                            color:
                                Color(0xFFFF7700), // Color del globo de texto
                          ...
                          child: Text(
                            "¿No tienes cuenta?", // Cambia este texto según sea necesario
                            style: GoogleFonts.manrope(
